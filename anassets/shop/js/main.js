(function ($) {
    ...
    function siteToggleAction() {
        ...
        $('.ps-toggle--sidebar').on('click', function (e) {
            ...
            if ($('.ps-panel--sidebar').hasClass('active')) {
        ...
        $('.ps-panel__header .close').on('click', function (e) {
            e.preventDefault();
        ...
        if (target.length > 0) {
            target.each(function () {
                var el = $(this),
                    ...
                    dataHoverPause = el.data('owl-hover-pause'),
                ...
                if (target.children('div, span, a, img, h1, h2, h3, h4, h5, h5').length >= 2) {
                    el.owlCarousel({
                        ...
                        autoplayHoverPause: dataHoverPause,
                        loop: dataLoop,
                        nav: dataNav,
    ...
    $.fn.removeClassContain = function (filter) {
    ...
    $('document').ready(function () {
        if ($('.floating-cart').is(':visible')) {
            $('footer').css({
                "margin-bottom": "40px"
            });
        }
        $('.owl-item [class*=col-]').removeClassContain('col');
    });
    ...
    $('input.noSpace').on('change', function () {
