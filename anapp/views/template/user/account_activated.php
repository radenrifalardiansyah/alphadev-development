...
<body style="background-color:#e2e1e0;font-family: Open Sans, sans-serif;font-size:100%;font-weight:400;line-height:1.4;color:#000;">
    <table style="max-width:670px;margin:50px auto 10px;background-color:#fff;
        ...
        <tbody>
            <tr>
                <td colspan="2" style="font-size:16px;padding:30px 15px 10px 15px;font-weight: bold;">
                    Selamat, <span style="text-transform:capitalize"><?= $user->name ?></span>
                    <br><br>
                    Akun anda telah aktif atau sukses di perpanjang
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="border: solid 1px #ddd; padding:10px 20px;" class="group-list">
                    <p style="font-size:14px;margin:0 0 8px 0;">
                        <span class="title-list">Tipe Akun</span><span style="text-transform:uppercase;">: <?= str_replace('_', ' ', $user->type) ?> </span>
                    </p>
                    <p style="font-size:14px;margin:0 0 8px 0;">
