<table class="table align-items-center table-flush" id="list_table_shop_order" data-url="<?php echo base_url('shopping/shoporderlistsdata/'.an_encrypt('member_to_stockist') .'/'. an_encrypt('shop')); ?>">
    <thead class="thead-light">
        <tr role="row" class="heading">
            <th scope="col" style="width: 10px" rowspan="2">#</th>
            <th scope="col" class="text-center" rowspan="2">Invoice</th>
            <th scope="col" class="text-center" colspan="2">Mitra</th>
            <th scope="col" class="text-center" colspan="2">Sub/Agency</th>
