<div class="card-body pt-0">
    <div class="nav-wrapper">
        <ul class="nav nav-pills nav-fill flex-column flex-sm-row" id="tabs-icons-text" role="tablist">
            ...
            <li class="nav-item mb-3">
                <a class="nav-link btn_shop_order_status" id="tabs-shop-confirmed-tab" data-status="confirmed" data-toggle="tab" href="#tabs-shop-confirmed" role="tab" aria-controls="tabs-shop-confirmed-tab" aria-selected="false"><i class="fa fa-check"></i> Confirmed</a>
            </li>
            <li class="nav-item mb-3">
        ...
        <div class="card-body px-0">
            <div class="tab-content" id="shopOrderContent">
                ...
                <div class="tab-pane fade show active" id="tabs-shop-pending" role="tabpanel" aria-labelledby="tabs-shop-pending-tab">
                    <h3 class="heading-small px-3"><i class="ni ni-bag-17 mr-2"></i> <?php echo lang('menu_report_sales'); ?> (PENDING)</h3>
                    <div class="table-container">
                        ...
                        <table class="table align-items-center table-flush" id="list_table_shop_pending" data-url="<?php echo base_url('shopping/shoporderlistsdata/'.an_encrypt('mine') .'/'. an_encrypt('pending')); ?>">
                ...
                <div class="tab-pane fade" id="tabs-shop-confirmed" role="tabpanel" aria-labelledby="tabs-shop-confirmed-tab">
                    <h3 class="heading-small px-3"><i class="fa fa-check mr-2"></i> <?php echo lang('menu_report_sales'); ?> (CONFIRMED)</h3>
                    <div class="table-container">
                        <div class="table-actions-wrapper table-group-actions text-right">
                            <button class="btn btn-sm btn-info text-white table-export-excel">
        						<i class="fa fa-share-square"></i> <span class="hidden-480">Export ke Excel</span>
                        ...
                        <table class="table align-items-center table-flush" id="list_table_shop_confirmed" data-url="<?php echo base_url('shopping/shoporderlistsdata/'.an_encrypt('mine') .'/'. an_encrypt('confirmed')); ?>">
                            <thead class="thead-light">
                                <tr role="row" class="heading">
                                    <th scope="col" style="width: 10px">#</th>
                                    <th scope="col" class="text-center">Invoice</th>
                ...
                <div class="tab-pane fade" id="tabs-shop-cancelled" role="tabpanel" aria-labelledby="tabs-shop-cancelled-tab">
                    <h3 class="heading-small px-3"><i class="fa fa-times mr-2"></i> <?php echo lang('menu_report_sales'); ?> (CANCELLED)</h3>
                    <div class="table-container">
                        <div class="table-actions-wrapper table-group-actions text-right">
                            <button class="btn btn-sm btn-info text-white table-export-excel">
        						<i class="fa fa-share-square"></i> <span class="hidden-480">Export ke Excel</span>
                        ...
                        <table class="table align-items-center table-flush" id="list_table_shop_cancelled" data-url="<?php echo base_url('shopping/shoporderlistsdata/'.an_encrypt('mine') .'/'. an_encrypt('cancelled')); ?>">
                            <thead class="thead-light">
                                <tr role="row" class="heading">
                                    <th scope="col" style="width: 10px">#</th>
                                    <th scope="col" class="text-center">Invoice</th>
