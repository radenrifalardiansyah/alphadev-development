...
<div class="card-body pt-0">
    <div class="row mb-3">
        ...
        <div class="col-md-6 text-right">                 
            <a href="<?php echo base_url('member/loan'); ?>" class="btn btn-sm btn-outline-warning"><i class="fa fa-step-backward"></i> <?php echo lang('back'); ?></a>
        </div>
    </div>  
    ...
    <div class="table-container">
        <table class="table align-items-center table-flush" id="list_table_member_loan" data-url="<?php echo base_url('member/memberloanlistsdata/'.$member_other_id); ?>">
