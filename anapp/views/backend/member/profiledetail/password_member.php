<?php echo form_open( 'member/changepassword', array( 'id'=>'cpassword', 'role'=>'form', 'enctype'=>'multipart/form-data' ) ); ?>
    <input type="hidden" name="id_member_other" value="<?php echo $member_other->id; ?>" />
    <input type="hidden" name="username_other" value="<?php echo $member_other->username; ?>" />    
    ...
    <div class="form-group">
        <label class="control-label">Konfirmasi Password Baru <span class="required">*</span></label>
        <div class="input-group">
