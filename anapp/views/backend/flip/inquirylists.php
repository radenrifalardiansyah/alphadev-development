                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-light">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo lang('menu_flip_inquiry'); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="table-container">
                    <table class="table align-items-center table-flush" id="list_table_flip_inquiry" data-url="<?php echo base_url('flip/flipinquirylistdata'); ?>">
                        <thead class="thead-light">
                            ...
                            <tr role="row" class="filter" style="background-color: #f6f9fc">
                                ...
                                <td style="text-align: center;">
                                    <button class="btn btn-sm btn-outline-default btn-tooltip filter-submit" id="btn_list_table_flip_inquiry" title="Search"><i class="fa fa-search"></i></button>
